...
public class BinaryOperatorImpl extends MinimalEObjectImpl.Container implements BinaryOperator
{
  ...
  {
    return CupidoPackage.Literals.BINARY_OPERATOR;
  }
  ...
  public void setOp(String newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CupidoPackage.BINARY_OPERATOR__OP, oldOp, op));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CupidoPackage.BINARY_OPERATOR__OP:
        return getOp();
    }
