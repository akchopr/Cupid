...
public class ParamImpl extends MinimalEObjectImpl.Container implements Param
{
  ...
  {
    return CupidoPackage.Literals.PARAM;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CupidoPackage.PARAM__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CupidoPackage.PARAM__NAME:
        return getName();
    }
