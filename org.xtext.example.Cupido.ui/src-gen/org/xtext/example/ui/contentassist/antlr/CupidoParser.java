		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIntervalAccess().getRightAssignment_1_4(), "rule__Interval__RightAssignment_1_4");
					put(grammarAccess.getIntervalAccess().getEventAssignment_2_0(), "rule__Interval__EventAssignment_2_0");
					put(grammarAccess.getIntervalAccess().getRightAssignment_2_3(), "rule__Interval__RightAssignment_2_3");
					put(grammarAccess.getIntervalAccess().getEventAssignment_3_0(), "rule__Interval__EventAssignment_3_0");
					put(grammarAccess.getIntervalAccess().getLeftAssignment_3_2(), "rule__Interval__LeftAssignment_3_2");
